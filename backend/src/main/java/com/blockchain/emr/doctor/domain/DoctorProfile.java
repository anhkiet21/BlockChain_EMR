...
public class DoctorProfile {
    ...
    @Column(name = "institution_status", length = 30)
    ...
    public void setInstitution(InstitutionProfile institution, String status) {
        this.institutionProfile = institution;
        this.institutionStatus = status;
    }

    public void setInstitutionStatus(String status) {
        this.institutionStatus = status;
    }
