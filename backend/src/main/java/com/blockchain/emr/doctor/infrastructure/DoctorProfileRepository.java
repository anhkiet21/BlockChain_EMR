...
public interface DoctorProfileRepository extends JpaRepository<DoctorProfile, Long> {
    ...
    java.util.List<DoctorProfile> findByInstitutionProfileId(Long institutionProfileId);
    java.util.List<DoctorProfile> findByInstitutionProfileIdAndInstitutionStatus(Long institutionProfileId, String status);
}
